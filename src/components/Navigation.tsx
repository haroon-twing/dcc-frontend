  ...
  const navigation = useMemo(() => [
    ...
    },
    {
      ...
      children: [
        ...
        { name: "Illegal Sims", href: "/illegal-spectrum/illegal-sims" },
        { name: "Smuggling (Food Commodities, Routine Use items, fuel etc.)", href: "/illegal-spectrum/smuggling" },
        { name: "Illegal Warehouses", href: "/illegal-spectrum/illegal-warehouses" },
        { name: "NCP Vehicles", href: "/illegal-spectrum/ncp-vehicles" },
        { name: "Human Trafficking", href: "/illegal-spectrum/human-trafficking" },
      ],
    },
